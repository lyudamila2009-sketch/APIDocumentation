...
- [ ] Swagger-аннотации добавлены ко всем обработчикам (`handlers/user.go`, `handlers/todo.go`)
- [ ] Спецификация OpenAPI сгенерирована (`docs/swagger.json`)
- [ ] Сервер запускается без ошибок (`go run main.go`)
- [ ] Swagger UI доступен по адресу `http://localhost:8080/swagger/`
- [ ] Все эндпоинты API корректно обрабатывают запросы
...
**[Создать issue](https://github.com/lyudamila2009-sketch/APIDocumentation/issues)**
